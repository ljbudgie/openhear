...
OpenHear exists to give people sovereignty over their own senses. That mission
applies to this community too: every contributor — deaf, hard of hearing,
hearing, neurodivergent, and otherwise — has an equal right to be heard.
...
- Publishing others' private information, such as a physical or email address,
  audiogram data, or hearing-aid fitting profiles, without their explicit
  permission.
...
reported to the project maintainers via a private GitHub Security Advisory at
<https://github.com/ljbudgie/openhear/security/advisories/new> (use the
