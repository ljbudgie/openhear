...
#: USB Vendor ID for HIMSA Noahlink Wireless 2 (confirmed from device, serial 2545015785).
#: Previous value 0x0484 was incorrect.
NOAHLINK_VENDOR_ID: int = 0x16f0

#: USB Product ID for HIMSA Noahlink Wireless 2 (confirmed from device).
#: Previous value 0x006E was incorrect.
NOAHLINK_PRODUCT_ID: int = 0x0003
