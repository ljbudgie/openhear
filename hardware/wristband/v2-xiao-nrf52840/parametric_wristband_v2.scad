...
case_length_mm        = 46.0;   // [40:1:52]   long axis (lug-to-lug body) — increased from 44 to compensate for wall fix
case_width_mm         = 40.0;   // [34:1:44]   short axis (across wrist) — increased from 38 to compensate for wall fix
...
wall_thickness_mm     = 2.0;    // [0.8:0.1:2.4] — increased from 1.0: 5× 0.4 mm / 4× 0.5 mm nozzle perimeters
floor_thickness_mm    = 1.2;    // [0.8:0.1:1.6] — increased from 1.1 for print consistency
